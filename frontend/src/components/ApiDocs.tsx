export default function ApiDocs() {
  ...
  return (
    <div className="card api-docs">
      ...
      <h4 style={{ marginTop: 16, marginBottom: 8, color: 'var(--accent)' }}>Deposits</h4>
      <p><code>GET /v1/deposit-memo?baseRecipient=0x...</code> &mdash; Generate deposit memo</p>
      ...
      <h4 style={{ marginTop: 16, marginBottom: 8, color: 'var(--accent)' }}>Withdrawals</h4>
