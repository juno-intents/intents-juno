...
resource "aws_security_group" "wireguard" {
  ...
  description = "Security group for intents-juno backoffice WireGuard gateway"
  vpc_id      = data.aws_vpc.selected.id
...
resource "aws_instance" "wireguard_gateway" {
  ...
  user_data = <<-EOF
    ...
    wireguard_backoffice_hostname="${var.shared_wireguard_backoffice_hostname}"
    wireguard_backoffice_private_endpoint="${var.shared_wireguard_backoffice_private_endpoint}"
    ...
    address=/${var.shared_wireguard_backoffice_hostname}/${var.shared_wireguard_backoffice_private_endpoint}
