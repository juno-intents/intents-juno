...
main() {
  ...
  assert_not_contains "$main_tf" 'name  = "SP1_REQUEST_CIRCUIT_VERSION"' "production-shared proof task env does not inject a split SP1 request circuit version override"
  assert_not_contains "$main_tf" 'value = "v6.1.0"' "production-shared proof task env does not pin a split SP1 request circuit version override"
