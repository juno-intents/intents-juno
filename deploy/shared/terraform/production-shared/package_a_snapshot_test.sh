...
main() {
  ...
  assert_contains "$main_tf" 'local.shared_queue_driver == "postgres" ? local.shared_queue_postgres_args : local.shared_queue_kafka_args' "production-shared proof commands switch queue args by transport"
  assert_contains "$main_tf" '--queue-driver ${local.shared_queue_driver}' "production-shared proof-role systemd units use the selected queue driver"
  assert_contains "$main_tf" '${local.shared_queue_driver == "postgres" ? "--queue-postgres-dsn-env POSTGRES_DSN" : "--queue-brokers ${local.shared_kafka_bootstrap_brokers}"}' "production-shared proof-role systemd units switch queue args by transport"
