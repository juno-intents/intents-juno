...
JUNO_DKG_VERSION_DEFAULT="${JUNO_DKG_VERSION_DEFAULT:-v0.1.1}"
JUNO_TXSIGN_VERSION_DEFAULT="${JUNO_TXSIGN_VERSION_DEFAULT:-v1.6}"
JUNO_TXBUILD_VERSION_DEFAULT="${JUNO_TXBUILD_VERSION_DEFAULT:-v1.6.2}"
JUNO_DKG_HOME_DEFAULT="${JUNO_DKG_HOME_DEFAULT:-$HOME/.juno-dkg}"
JUNO_GO_TOOLCHAIN_DEFAULT="${JUNO_GO_TOOLCHAIN_DEFAULT:-go1.24.13+auto}"

export GOTOOLCHAIN="${GOTOOLCHAIN:-$JUNO_GO_TOOLCHAIN_DEFAULT}"
