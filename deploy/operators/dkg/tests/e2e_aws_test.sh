...
test_aws_wrapper_wires_shared_services_into_remote_e2e() {
  ...
  assert_contains "$wrapper_script_text" "run_with_local_timeout 1800 docker buildx build --platform linux/amd64" "proof services image buildx path uses a bounded local timeout to prevent indefinite buildx hangs"
