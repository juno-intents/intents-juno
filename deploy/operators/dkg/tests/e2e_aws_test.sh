...
test_local_e2e_supports_shared_infra_validation() {
  ...
  assert_contains "$e2e_script_text" "/v1/deposits/submit" "live e2e submits deposit through bridge-api write endpoint"
  assert_contains "$e2e_script_text" "/v1/withdrawals/request" "live e2e submits withdraw request through bridge-api write endpoint"
