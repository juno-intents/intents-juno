...
bash "$SCRIPT_DIR/runtime_material_refs_test.sh"
bash "$SCRIPT_DIR/deploy_coordinator_test.sh"
bash "$SCRIPT_DIR/deploy_operator_test.sh"
bash "$SCRIPT_DIR/deploy_operator_live_test.sh"
...
bash "$SCRIPT_DIR/package_mainnet_release_live_test.sh"
bash "$SCRIPT_DIR/canary_shared_services_test.sh"
bash "$SCRIPT_DIR/canary_shared_services_ssm_test.sh"
...
bash "$SCRIPT_DIR/run_operator_local_canary_test.sh"
bash "$SCRIPT_DIR/canary_operator_boot_test.sh"
bash "$SCRIPT_DIR/canary_operator_boot_live_test.sh"
bash "$SCRIPT_DIR/deploy_app_host_test.sh"
bash "$SCRIPT_DIR/canary_app_host_test.sh"
bash "$SCRIPT_DIR/prepare_runtime_materials_test.sh"
bash "$SCRIPT_DIR/content_hygiene_test.sh"
bash "$SCRIPT_DIR/build_operator_stack_ami_test.sh"
