...
main() {
  ...
  assert_contains "$workflow_text" 'go build -o .ci/out/checkpoint-signer_linux_amd64 ./cmd/checkpoint-signer' "release workflow builds checkpoint-signer"
  ...
  assert_contains "$workflow_text" 'sha256sum checkpoint-signer_linux_amd64 > checkpoint-signer_linux_amd64.sha256' "release workflow hashes checkpoint-signer"
  ...
  assert_contains "$workflow_text" '.ci/out/checkpoint-signer_linux_amd64' "release workflow uploads checkpoint-signer"
  ...
  assert_contains "$upload_block" '.ci/out/checkpoint-signer_linux_amd64 \' "release workflow uploads checkpoint-signer binary when updating a release"
  assert_contains "$upload_block" '.ci/out/checkpoint-signer_linux_amd64.sha256 \' "release workflow uploads checkpoint-signer checksum when updating a release"
  ...
  assert_contains "$create_block" '.ci/out/checkpoint-signer_linux_amd64 \' "release workflow uploads checkpoint-signer binary when creating a release"
  assert_contains "$create_block" '.ci/out/checkpoint-signer_linux_amd64.sha256 \' "release workflow uploads checkpoint-signer checksum when creating a release"
