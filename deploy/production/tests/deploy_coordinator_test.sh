...
EOF
  ...
  assert_eq "$(jq -r '.services.bridge_api.public_url' "$output_dir/alpha/app/app-deploy.json")" "http://bridge.alpha.intents-testing.thejunowallet.com:8082" "app manifest bridge url"
  rm -rf "$workdir"
}
